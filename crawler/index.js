...
const SORT = ['recommend', 'time', 'rank']

const random = Math.floor(Math.random() * 3)

const listUrl = (type) => `https://movie.douban.com/j/search_subjects?type=movie&tag=${encodeURIComponent(type)}&sort=${SORT[random]}&page_limit=40&page_start=0`
